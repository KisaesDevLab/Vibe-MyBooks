...
**Target License:** PolyForm Small Business 1.0.0 + Supplemental Commercial License  
**Date:** April 2026
...
Migrate Vibe MyBooks from Elastic License 2.0 to the PolyForm Small Business License 1.0.0. PolyForm Small Business permits individuals and firms to use and modify the software for internal business operations while explicitly prohibiting distribution and any use beyond internal operations. There is no conversion timer — restrictions are permanent. A supplemental Commercial License covers the specific case of firms providing client-facing portal access to a hosted instance.

### Why PolyForm Small Business Over ELv2

| Requirement | ELv2 (current) | PolyForm Small Business |
|---|---|---|
...
### 1.1 Prepare the PolyForm Small Business License

- [ ] Download the canonical PolyForm Small Business 1.0.0 text from https://polyformproject.org/licenses/small-business/1.0.0
...
This covers two things PolyForm Small Business doesn't address directly: **client-facing access** and **license key protection**.
...
- [ ] Create a `LICENSING_FAQ.md` covering the most common questions:
  ...
  - "Is this open source?" → No. The source code is publicly viewable, but PolyForm Small Business is not an OSI-approved open source license. It's a source-available license that permits internal use only.

### Ship Gate — Phase 1
- [ ] PolyForm Small Business license text finalized with licensor preamble
...
- [ ] Replace `LICENSE` file with the licensor preamble + full PolyForm Small Business 1.0.0 text
- [ ] Update `NOTICE` file:
...
- [ ] Update `README.md`:
  - Change license badge from ELv2 to PolyForm Small Business 1.0.0
  - Replace the License section:
    - Change "Elastic License 2.0 (ELv2)" → "PolyForm Small Business License 1.0.0"
...
- [ ] Update `CLAUDE.md` license reference from ELv2 to PolyForm Small Business 1.0.0
- [ ] Update `BUILD_PLAN.md`:
  - Change all references from "ELv2" / "Elastic License 2.0" to "PolyForm Small Business 1.0.0"
  - Update the file structure section: `LICENSE` comment to `# PolyForm Small Business 1.0.0`
  - Update Phase 11.3 docs checklist
- [ ] Update any `CONTRIBUTING.md` to reference PolyForm Small Business contributor terms
...
- [ ] Update `package.json` → `"license": "SEE LICENSE IN LICENSE"` (PolyForm Small Business is not an SPDX identifier)
...
- [ ] Make all license changes in a single commit: `license: migrate from ELv2 to PolyForm Small Business 1.0.0`
...
### Ship Gate — Phase 2
- [ ] Vibe MyBooks repo has LICENSE (PolyForm Small Business), NOTICE, COMMERCIAL_LICENSE.md, LICENSING_FAQ.md
...
- [ ] README, CLAUDE.md, and BUILD_PLAN.md all reflect PolyForm Small Business
...
- [ ] Include license details in release notes:
  - What changed: ELv2 → PolyForm Small Business 1.0.0
...
- [ ] Update the Kisaes LLC website:
  ...
  - "Source Available — PolyForm Small Business" messaging
...
### Ship Gate — Phase 3
- [ ] All external-facing materials reflect PolyForm Small Business
...
## Appendix A — PolyForm Small Business License 1.0.0 (Full Text)
...
```
<!-- Copyright 2026 Kisaes LLC — PolyForm Small Business 1.0.0 -->
```
...
| Decision | Rationale |
|----------|-----------|
| PolyForm Small Business over ELv2 | ELv2 explicitly grants redistribution ("distribute, make available") which is not desired. PolyForm explicitly blocks it. |
| PolyForm Small Business over modified ELv2 | Modifying ELv2 to remove redistribution creates a non-standard license that can't be called ELv2. PolyForm says what we need out of the box. |
