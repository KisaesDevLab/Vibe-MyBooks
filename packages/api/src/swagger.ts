          ...
          data: {
            ...
            items: {
              ...
              properties: {
                ...
                debit: { type: 'number', description: 'Netted debit balance (proper TB format — exactly one of debit/credit is nonzero)' },
                credit: { type: 'number', description: 'Netted credit balance' },
                total_debit: { type: 'number', description: 'Gross debit activity (legacy; kept for compatibility)' },
                total_credit: { type: 'number', description: 'Gross credit activity (legacy; kept for compatibility)' },
              },
            },
          },
          totalDebits: { type: 'number', description: 'Sum of the netted debit column' },
          totalCredits: { type: 'number', description: 'Sum of the netted credit column' },
        },
      },
      ProfitAndLoss: {
        type: 'object',
