          ...
          {selectedId && (
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Button variant="secondary" size="sm"
                    onClick={() => navigate(`/transactions/new/journal-entry?template=${selectedId}`)}>
              ...
              <div className="bg-white rounded-lg border">
                ...
                <div className="px-4 py-2 grid grid-cols-12 gap-2 text-[11px] uppercase tracking-wide text-gray-400 border-b">
