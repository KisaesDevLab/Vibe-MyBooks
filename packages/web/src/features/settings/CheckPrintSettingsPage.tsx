...
export function CheckPrintSettingsPage() {
  ...
  useEffect(() => {
    if (data?.settings) {
      ...
      setForm({
        ...
        printPayeeAddress: s.printPayeeAddress ?? true,
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    updateSettings.mutate({
      ...
      printPayeeAddress: form.printPayeeAddress,
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 space-y-4">
          ...
          {[
            ...
            { key: 'printPayeeAddress', label: 'Payee address block', desc: 'Payee name + mailing address positioned for double-window envelopes' },
