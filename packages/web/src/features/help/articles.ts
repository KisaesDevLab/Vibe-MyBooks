...
4. The new company is created with its own Chart of Accounts, seeded from the template for that business type (industry revenue and expense accounts included). You can add, rename or deactivate accounts afterward.
