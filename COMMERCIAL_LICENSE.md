# Vibe MyBooks — Commercial License
...
- **Accounting firm internal use** — your firm's own books, internal invoicing, internal operations
- **Staff-operated client work** — your accountants/bookkeepers use Vibe MyBooks to perform bookkeeping on behalf of clients, as long as the firm controls the instance and clients do not have direct login access

## License Key Clause

Licensees under this Commercial License shall not move, change, disable, or circumvent any license key functionality in the Licensed Software, nor remove or obscure any functionality protected by a license key. Any such action is a material breach of this agreement and will terminate the Commercial License immediately.

## License Tiers

| Tier | Description | Contact |
|------|-------------|---------|
| Per-firm annual (unlimited) | Unlimited client entities | licensing@kisaes.com |
| Per-firm annual (capped) | Up to N client entities | licensing@kisaes.com |
| Per-client-entity monthly | Pay per client | licensing@kisaes.com |

Pricing is published separately. Contact licensing@kisaes.com for a current quote.

## What the Commercial License Grants

- Right to deploy the Licensed Software and provide access to third-party clients within the scope of the purchased tier
- Right to modify the Licensed Software for client-facing deployment
- Right to host the Licensed Software on infrastructure of your choosing (self-hosted, cloud, managed)

## What the Commercial License Does NOT Grant

- Right to redistribute the source code
- Right to white-label and resell the Licensed Software to other firms
...
For commercial licensing inquiries: **licensing@kisaes.com**
